...
import com.mobil.otomasyon.model.ElementInfo;
...
public class IOSSelector implements Selector {
  ...
  public By getElementInfoToBy(ElementInfo elementInfo) {
    ...
    } else if (elementInfo.getIosType().equals("accessibility id")){
      by = MobileBy.AccessibilityId(elementInfo.getIosValue());
    } else if (elementInfo.getIosType().equals("ios predicate")){
      by = MobileBy.iOSNsPredicateString(elementInfo.getIosValue());
    }
    return by;
  }
